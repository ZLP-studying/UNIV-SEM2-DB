...
// ---------------------
// Districts names
const DISTRICTS_NAMES: [&str; 4] = ["Митино", "Крылатское", "Ховрино", "Зеленоград"];
...
// -----
// Type names
const TYPE_NAMES: [&str; 3] = ["Квартира", "Дом", "Апартаменты"];

// ---------
// Materials
// ---------
// Number of materials
const MATERIALS_NAMES: [&str; 2] = ["Панель", "Кирпич"];
